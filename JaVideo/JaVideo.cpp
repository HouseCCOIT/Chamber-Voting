...
// JaVideo.cpp : Defines the class behaviors for the application.
//
...
BEGIN_MESSAGE_MAP(CJaVideoApp, CWinApp)
...
// CJaVideoApp construction

CJaVideoApp::CJaVideoApp()
{
...
// The one and only CJaVideoApp object

CJaVideoApp theApp;


// CJaVideoApp initialization

BOOL CJaVideoApp::InitInstance()
{
   ...
   m_hMutexOneInstance = CreateMutex(NULL, TRUE, "CJaVideoApp");
