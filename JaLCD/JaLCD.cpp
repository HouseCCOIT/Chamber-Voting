...
// JaLCD.cpp : Defines the class behaviors for the application.
//
...
BEGIN_MESSAGE_MAP(CJaLCDApp, CWinApp)
...
// The one and only CJaLCDApp object

CJaLCDApp theApp;


// CJaLCDApp initialization

BOOL CJaLCDApp::InitInstance()
{
