...
// JaCallIn.cpp : Defines the class behaviors for the application.
//
...
BEGIN_MESSAGE_MAP(CJaCallInApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// CJaCallInApp construction

CJaCallInApp::CJaCallInApp()
{
...
// The one and only CJaCallInApp object

CJaCallInApp theApp;


// CJaCallInApp initialization

BOOL CJaCallInApp::InitInstance()
{
	HWND existingApp = FindWindow(0, "Remote Call In Vote");
	if (existingApp) {
