...
public:
   ...
   unsigned int voteDeskLights(unsigned char seat, unsigned int voteIn);
   unsigned int voteBoardLights(unsigned char seat, unsigned int voteIn, unsigned int seat2);
   ...
   unsigned int voteBoardLightsRemote(unsigned char seat, unsigned int voteIn, unsigned int seat2);
   unsigned int voteDeskLightsRemote(unsigned char seat, unsigned int voteIn);
