...
// LCDDisplay.cpp : Defines the class behaviors for the application.
//
...
BEGIN_MESSAGE_MAP(CLCDDisplayApp, CWinApp)
...
// The one and only CLCDDisplayApp object

CLCDDisplayApp theApp;


// CLCDDisplayApp initialization

BOOL CLCDDisplayApp::InitInstance()
{
	CWinApp::InitInstance();

	const char szUniqueNamedMutex[] = "com_mhr_apps_lcd";
	HANDLE hHandle = CreateMutex(NULL, TRUE, szUniqueNamedMutex);
	if (ERROR_ALREADY_EXISTS == GetLastError()) {
		// Program already running somewhere
		AfxMessageBox("LCD DispLAY already running.");
