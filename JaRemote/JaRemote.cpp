...
// JaRemote.cpp : Defines the class behaviors for the application.
//
...
BEGIN_MESSAGE_MAP(CJaRemoteApp, CWinApp)
...
// CJaRemoteApp construction

CJaRemoteApp::CJaRemoteApp()
{
...
// The one and only CJaRemoteApp object

CJaRemoteApp theApp;


// CJaRemoteApp initialization

BOOL CJaRemoteApp::InitInstance()
{
	HWND existingApp = FindWindow(0, "Remote Vote");
	if (existingApp) {
