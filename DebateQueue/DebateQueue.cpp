...
// DebateQueue.cpp : Defines the class behaviors for the application.
//
...
BEGIN_MESSAGE_MAP(CDebateQueueApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// CDebateQueueApp construction

CDebateQueueApp::CDebateQueueApp()
{
...
// The one and only CDebateQueueApp object

CDebateQueueApp theApp;


// CDebateQueueApp initialization

BOOL CDebateQueueApp::InitInstance()
{
	HWND existingApp = FindWindow(0, "Debate Queue");
	if (existingApp) {
